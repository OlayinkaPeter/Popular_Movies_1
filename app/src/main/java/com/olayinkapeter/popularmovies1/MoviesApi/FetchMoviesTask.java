package com.olayinkapeter.popularmovies1.MoviesApi;
...
//        String address = API.API_URL + API.SORT_TYPE_POPULAR
//                +API.API_KEY;
//
//        Uri builtUri = Uri.parse(address);

        Uri builtUri = Uri.parse(API.API_URL + API.APPEND).buildUpon()
